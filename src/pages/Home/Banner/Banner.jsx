...
const Banner = () => {
    return (
        <div className="carousel w-full h-[550px] rounded-xl">
            ...
            <div className="absolute w-full h-full text-white gap-5 transform bg-gradient-to-r from-[#925b99] to-[rgba(21, 21, 21,0)]">
            <div className='px-20 pt-28'>
            <h1 className='text-[#181d4e] text-6xl font-bold lg:w-4/5 mb-5'>Pick the best toy for your beloved child from <span className='text-6xl font-bold text-pink-500'>Toys</span> <span className=' text-yellow-400'>House</span></h1>
