...
const CategoryCard = ({toy}) => {
    ...
    return (
        <div className='border-2 shadow-2xl border-pink-600 p-5 lg:flex gap-5 rounded-xl lg:items-center'>
            <div className='lg:w-[50%] lg:h-full'>
                <img className='w-full lg:h-full rounded-lg object-center' src={toyImage} alt="" />
            </div>
